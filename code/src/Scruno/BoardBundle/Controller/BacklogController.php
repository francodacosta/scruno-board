...
use Scruno\BoardBundle\Entity\Backlog;
use Scruno\BoardBundle\Form\BacklogType;
...
class BacklogController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ScrunoBoardBundle:Backlog')->findAll();

        return $this->render('ScrunoBoardBundle:Backlog:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ScrunoBoardBundle:Backlog:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ScrunoBoardBundle:Backlog')->find($id);
        ...
        return $this->render('ScrunoBoardBundle:Backlog:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ScrunoBoardBundle:Backlog:edit.html.twig', array(
            'entity'      => $entity,
