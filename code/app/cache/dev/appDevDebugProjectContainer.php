...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ScrunoBoardBundle', '/var/www/html/app/Resources/ScrunoBoardBundle/views', '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ScrunoBoardBundle', '/var/www/html/src/Scruno/BoardBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    /**
     * Gets the 'board_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Scruno\BoardBundle\Services\BoardService A Scruno\BoardBundle\Services\BoardService instance.
     */
    protected function getBoardServiceService()
    {
        return $this->services['board_service'] = new \Scruno\BoardBundle\Services\BoardService($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'scruno', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, $c, array());
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager518fe48de68b2_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager518fe48de68b2_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once '/var/www/html/app/cache/dev/jms_diextra/doctrine/EntityManager_518fe48de68b2.php';

        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_2e56b5b382879b2d6ed83ba264388845');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_2e56b5b382879b2d6ed83ba264388845');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_2e56b5b382879b2d6ed83ba264388845');

        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array('/var/www/html/src/Scruno/BoardBundle/Resources/config/doctrine' => 'Scruno\\BoardBundle\\Entity', '/var/www/html/src/Scruno/AuthBundle/Resources/config/doctrine' => 'Scruno\\AuthBundle\\Entity'));
        $d->setGlobalBasename('mapping');

        $e = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $e->addDriver($d, 'Scruno\\BoardBundle\\Entity');
        $e->addDriver($d, 'Scruno\\AuthBundle\\Entity');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('ScrunoBoardBundle' => 'Scruno\\BoardBundle\\Entity', 'ScrunoAuthBundle' => 'Scruno\\AuthBundle\\Entity'));
        $f->setMetadataCacheImpl($a);
        $f->setQueryCacheImpl($b);
        $f->setResultCacheImpl($c);
        $f->setMetadataDriverImpl($e);
        $f->setProxyDir('/var/www/html/app/cache/dev/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager518fe48de68b2_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($g, $this);
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), '44049ca9caf5b7ad6fc77430fabb71f3');
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/var/www/html/app/cache/dev/jms_diextra/metadata'));
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('/var/www/html/app/cache/dev/jms_security/expressions');
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/var/www/html/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security'));
    }
    ...
    {
        return $this->services['sensio.distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/var/www/html/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/var/www/html/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/var/www/html/app/cache/dev/sessions');
    }
    ...
    /**
     * Gets the 'task_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Scruno\BoardBundle\Services\TaskService A Scruno\BoardBundle\Services\TaskService instance.
     */
    protected function getTaskServiceService()
    {
        return $this->services['task_service'] = new \Scruno\BoardBundle\Services\TaskService($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/var/www/html/app/cache/dev/translations', 'debug' => true));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'cache' => '/var/www/html/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'ScrunoBoardBundle'), $this->get('assetic.value_supplier.default')));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/var/www/html/src/Scruno/BoardBundle/Resources/views', 'ScrunoBoard');
        $instance->addPath('/var/www/html/src/Scruno/AuthBundle/Resources/views', 'ScrunoAuth');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('44049ca9caf5b7ad6fc77430fabb71f3');
    }
     ...
     *
     * @return EntityManager518fe48de68b2_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/var/www/html/app/cache/dev/jms_security', true));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ScrunoBoardBundle' => 'Scruno\\BoardBundle\\ScrunoBoardBundle',
                'ScrunoAuthBundle' => 'Scruno\\AuthBundle\\ScrunoAuthBundle',
            ...
            'locale' => 'en',
            'secret' => '44049ca9caf5b7ad6fc77430fabb71f3',
            'database_path' => NULL,
            ...
            'kernel.secret' => '44049ca9caf5b7ad6fc77430fabb71f3',
            ...
            'swiftmailer.spool.memory.path' => '/var/www/html/app/cache/dev/swiftmailer/spool',
            ...
            'jms_aop.cache_dir' => '/var/www/html/app/cache/dev/jms_aop',
            ...
            'jms_di_extra.cache_dir' => '/var/www/html/app/cache/dev/jms_diextra',
            'jms_di_extra.disable_grep' => false,
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.cache_warmer.controller_file_blacklist' => array(

            ),
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/var/www/html/app/cache/dev/jms_diextra/doctrine/EntityManager_518fe48de68b2.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager518fe48de68b2_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => '/var/www/html/app/cache/dev/jms_security',
